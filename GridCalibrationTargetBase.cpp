...
GridCalibrationTargetBase::points3d( void ) const
{
...
Eigen::Vector3d
GridCalibrationTargetBase::point( size_t i ) const
{
...
GridCalibrationTargetBase::pointToGridCoordinates( size_t i ) const
{
...
size_t
GridCalibrationTargetBase::gridCoordinatesToPoint( size_t r, size_t c ) const
{
    return cols( ) * r + c;
}
...
///        by row and column
Eigen::Vector3d
GridCalibrationTargetBase::gridPoint( size_t r, size_t c ) const
{
    return _points.row( gridCoordinatesToPoint( r, c ) );
}

double*
GridCalibrationTargetBase::getPointDataPointer( size_t i )
{
    return &_points( i, 0 );
}
